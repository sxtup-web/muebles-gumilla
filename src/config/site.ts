export const siteConfig = {
  ...
  title: "Muebles Gumilla - Taller Artesanal",
  description: "Artesanía en madera desde el corazón de Santiago. Seis años creando piezas con alma, hechas a mano y a medida.",
};
